...
2.	Download MySQL and create database `inventory` and create table using the script in the file “CREATE_TABLE_stored_procedure”.
3.	Import this gradle project in to Eclipse.
4.	Configure database user/password in your hibernate code.
5.	Using command prompt go to the root directory of java project.
