...
public class ToyDAOTest {
	...
	public void testGetToyById() {
		...
		Toy toyRetrieved = toyDAO.getToyById(100);
	...
	public void testUpdateToy() {
		...
		toy.setStock(5);
		hibernateTemplate.save(toy);
		Toy existingToy = hibernateTemplate.get(Toy.class, 101);
		...
		Toy updatedToy = hibernateTemplate.get(Toy.class, 101);
	...
	public void testDeleteToy() {
		...
		toy.setStock(5);
		hibernateTemplate.save(toy);
		toyDAO.deleteToy(101);
		Toy deletedToy = hibernateTemplate.get(Toy.class, 101);
